...
"""
django-courses documentation build configuration file.
...
project = 'django-courses'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'django-courses'
...
#
# html_title = 'django-courses v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'It shows django courses list',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'courses_catalog'),
                os.path.join(root_path, 'courses_catalog/migrations')])
