#!/usr/bin/env python
"""
Package metadata for courses_catalog.
"""
import os
import re
import sys
...
VERSION = get_version('courses_catalog', '__init__.py')
...
setup(
    name='django-courses',
    version=VERSION,
    description="""It shows django courses list""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/openedx/django-courses',
    packages=find_packages(
        include=['courses_catalog', 'courses_catalog.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "courses_catalog = courses_catalog.apps:CoursesCatalogConfig",
        ],
    },
)
